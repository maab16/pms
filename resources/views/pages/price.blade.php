...
<section class="price-banner" id="price-banner">
    <div class="container price-banner-content">
        <div class="row">
            <div class="col-md-6">
                <h2 class="price-banner-title">One fixed monthly price, unlimited design</h2>
                <p class="price-banner-desc">Whether you order 1 or 10 designs, the price stays the same. We work as fast as we can on 1, 2 or more requests at a time depending of the chosen plan.</p>
                <p class="price-banner-desc">We offer a full 14 days money back guarantee.</p>
            </div>
        </div>
    </div>
