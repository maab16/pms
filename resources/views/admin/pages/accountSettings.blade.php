                ...
                <div class="card">
                    <div class="card-body">
                        <center class="mt-4"> <img src="{{ asset('dashboard/assets/images/users/5.jpg') }}" class="rounded-circle" width="150" />
                            <h4 class="card-title mt-2" id="user_name">{{ $user->first_name ." ".$user->last_name }}</h4>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3 col-xs-6 b-r"> <strong>Full Name</strong>
                                        <br>
                                        <p class="text-muted" id="profile_name">{{ $user->first_name." ".$user->last_name }}</p>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" id="profile_update_form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="first_name" id="first_name" placeholder="Johnathan Doe" class="form-control form-control-line" value="{{ $user->first_name }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Last Name</label>
                                        <div class="col-md-12">
                                            <input type="text" name="last_name" id="last_name" placeholder="Johnathan Doe" class="form-control form-control-line" value="{{ $user->last_name }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
